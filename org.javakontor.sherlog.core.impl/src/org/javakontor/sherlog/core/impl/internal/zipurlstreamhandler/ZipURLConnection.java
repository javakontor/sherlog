...
/**
 * A <code>URLConnection</code> which loads its content from a specified zip entry within a local file.
 */
public class ZipURLConnection extends URLConnection {
  ...
  /**
   * The <code>ZipFile</code> object for the zip file. Created when <code>connect()</code> is called.
   */
  private ZipFile      zipFile  = null;

  /**
   * The <code>ZipEntry</code> object for the entry in the zip file. Created when <code>connect()</code> is called.
   */
  private ZipEntry     zipEntry = null;

  /**
   * Creates a new <code>ZipURLConnection</code> for the specified zip entry within the specified <code>File</code>.
   */
