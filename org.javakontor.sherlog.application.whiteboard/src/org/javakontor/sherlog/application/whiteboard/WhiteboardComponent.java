...
/**
 * <p>
 * Implements a 'whiteboard component'. The whiteboard component is responsible
 * for tracking and registering all {@link ActionContribution
 * ActionContributions} and {@link ActionGroupContribution
 * ActionGroupContributions} that are registered with the OSGi service registry.
 * </p>
 * 
...
public class WhiteboardComponent {
	 ...
	 */
	public void addActionContributionAdmin(
			ActionContributionAdmin actionContributionAdmin) {
		// set the admin
	 ...
	 */
	public void removeActionContributionAdmin(
			ActionContributionAdmin actionContributionAdmin) {
		// unset the admin
		_admin = null;
	}
	 ...
	 */
	public void removeActionGroupContribution(
			ActionGroupContribution actionGroup) {
		if (_admin != null) {
